...
class TestRustBackend:
    ...
    def get_backends(id_to_col, param_to_size, param_to_col, param_size_plus_one, var_length):
        ...
        scipy_backend = get_backend(s.SCIPY_CANON_BACKEND, **kwargs)
    ...
    def test_mul_shapes(self, name, var_shape, const_shape, output_shape):
        ...
        if len(var_shape) > 2:
            # cvxpy emits an explicit reshape before a flat mul of an ND operand
            var_op = linOpHelper(shape=(var_size,), type="reshape", args=[var_op])
